...
int srv_getfile(int id, int64 offset, int64 blocksize, FILE *fdesc, int64 *byteswritten, unsigned char hash[16], mc_buf *skipfront = NULL, mc_buf *skipback = NULL);
...
int srv_getpreview(int id, unsigned char buf[16]);
