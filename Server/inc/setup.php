...
if(isset($_GET['phase1'])){
	$queries = array(
		...
		'CREATE TABLE mc_users (id INTEGER PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, token BINARY(16), lastseen INTEGER NOT NULL, lastregen INTERGER NOT NULL, UNIQUE(name)) COLLATE utf8_general_ci',
		...
		'CREATE TABLE mc_files (id INTEGER PRIMARY KEY AUTO_INCREMENT, uid INTEGER NOT NULL, name VARCHAR(511) NOT NULL, ctime INTEGER NOT NULL, mtime INTEGER NOT NULL, size INTEGER NOT NULL, is_dir BOOLEAN NOT NULL, parent INTEGER NOT NULL, status INTEGER NOT NULL, hash BINARY(16), INDEX(parent,uid), INDEX(id,uid)) COLLATE utf8_general_ci',
