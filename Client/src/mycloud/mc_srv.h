...
bool srv_isopen();
int srv_open(const std::string& url, const std::string& certfile, const std::string& user, const std::string& passwd, int64 *basedate, int *uid, bool acceptall = false);
int srv_standby();
int srv_close();
int srv_auth(const std::string& user, const std::string& passwd, int64 *basedate = NULL, int *uid = NULL);
int srv_timecheck();
int srv_listsyncs(std::list<mc_sync> *l);
int srv_listfilters(std::list<mc_filter> *l, int sid);
int srv_listshares(std::list<mc_share> *l, int sid);
int srv_listdir(std::list<mc_file> *l, int parent);
...
int srv_notifychange(const std::list<mc_sync_db>& l, int *id);
int srv_idusers(const std::list<int>& ids, std::list<mc_user> *l);

int srv_createsync(const std::string& name, bool crypted, int *id);
...
int srv_auth_async(mc_buf *ibuf, mc_buf* obuf, QtNetworkPerformer *perf, 
				   const std::string& user, const std::string& passwd, int64 *ltimea);
...
int srv_listsyncs_process(mc_buf *obuf, std::list<mc_sync> *l);
int srv_createsync_async(mc_buf *ibuf, mc_buf *obuf, QtNetworkPerformer *perf, const std::string& name, bool crypted);
...
int srv_listfilters_process(mc_buf *obuf, std::list<mc_filter> *l);
...
int srv_listshares_process(mc_buf *obuf, std::list<mc_share> *l);
...
int srv_listusers_process(mc_buf *obuf, std::list<mc_user> *l);
int srv_idusers_async(mc_buf *ibuf, mc_buf *obuf, QtNetworkPerformer *perf, const std::list<int>& l);
int srv_idusers_process(mc_buf *obuf, std::list<mc_user> *l);
int srv_notifychange_async(mc_buf *ibuf, mc_buf *obuf, QtNetworkPerformer *perf, const std::list<mc_sync_db>& l);
int srv_notifychange_process(mc_buf *obuf, int *id);
int srv_passchange_async(mc_buf *ibuf, mc_buf *obuf, QtNetworkPerformer *perf, const std::string& newpass);
int srv_passchange_process(mc_buf *obuf);
int srv_getkeyring_async(mc_buf *ibuf, mc_buf *obuf, QtNetworkPerformer *perf);
int srv_getkeyring_process(mc_buf *obuf, std::string *data);
int srv_setkeyring_async(mc_buf *ibuf, mc_buf *obuf, QtNetworkPerformer *perf, std::string *data);
