...
if(isset($_GET['phase1'])){
	$queries = array(
		...
		'CREATE TABLE mc_users (id INTEGER PRIMARY KEY AUTO_INCREMENT, name VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, token BINARY(16), lastseen INTEGER NOT NULL, UNIQUE(name)) COLLATE utf8_general_ci',
