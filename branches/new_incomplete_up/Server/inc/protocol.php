...
define("MC_SRVQRY_CREATESYNC",	201);
define("MC_SRVQRY_UPDATESYNC",	202);
define("MC_SRVQRY_DELETESYNC",	203);
define("MC_SRVQRY_LISTFILTERS",	300);
...
define("MC_SRVSTAT_FILTERLIST",	300);
